...
##                print we,ae,gasName,temp
        ...
        if started and Time1!=None and(time()-Time1>=interval):
           ...
           print {"DeviceId":boardNo,"Time":str(Time),"O3":str(o3),"SO2":str(so2),"NO2":str(no2),"CO":str(co),"PM10":'N/A',"PM1":'N/A',"PM2.5":'N/A',"LATITUDE":str(Lat),"LONGITUDE":str(Lon)}
           message={"DeviceId":boardNo,"Time":str(Time),"O3":str(o3),"SO2":str(so2),"NO2":str(no2),"CO":str(co),"PM10":'N/A',"PM1":'N/A',"PM2.5":'N/A',"LATITUDE":str(Lat),"LONGITUDE":str(Lon)}
           print('sending...')
           sbs.send_event('ehdevices',json.dumps(message))
           print('sent!')
