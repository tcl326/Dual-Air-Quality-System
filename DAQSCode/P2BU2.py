...
##        print('gps', gpsd.fix.latitude, gpsd.fix.longitude)
        print('gas', NO2, CO, O3, SO2, Temp, Humidity)
        writetd.writerow({'Time': 2})#, 'CO': CO, 'O3': O3, 'SO2': SO2, 'NO2': NO2, 
