...
def plotNow():
    plt.clf()
    #ylim(20,25)
##    plt.ax = plt.subplot(611)
##    plt.ax2 = plt.subplot(612, sharex = ax)
##    plt.ax3 = plt.subplot(613, sharex = ax)
##    plt.ax4 = plt.subplot(614, sharex = ax)
##    plt.ax5 = plt.subplot(615, sharex = ax)
##    plt.ax6 = plt.subplot(616, sharex = ax)

    plt.ax = plt.subplot(421)
    plt.ax2 = plt.subplot(422, sharex = ax)
    plt.ax3 = plt.subplot(423, sharex = ax)
    plt.ax4 = plt.subplot(424, sharex = ax)
    plt.ax5 = plt.subplot(425, sharex = ax)
    plt.ax6 = plt.subplot(426, sharex = ax)
    plt.ax7 = plt.subplot(427, sharex = ax)
#    plt.ax8 = plt.subplot(428, sharex = ax)
...
##    plt.ax8.grid(True)
    ...
    plt.ax7.set(ylabel='PPB')
##    plt.ax8.set(ylabel='PPB')
    
    plt.ax.plot(tempC, 'rx-', label='Temp')
    plt.ax2.plot(Humid, 'cx-', label='Humidity')
    plt.ax7.plot(GPM, 'bx-', label='PM10')
##    plt.ax8.plot(GPM2, 'bx-', label='PM10')
    ...
    plt.ax7.legend(loc='upper left')
##    plt.ax8.legend(loc='upper left')
...
no2aqii = aqi.to_aqi([(aqi.POLLUTANT_no2_1h, str(NO2i))]) #ppb
coaqii = aqi.to_aqi([(aqi.POLLUTANT_co_8h, str(COi))]) #ppm
o3aqii = aqi.to_aqi([(aqi.POLLUTANT_o3_1h, str(O3i))]) #ppm, 8hr
so2aqii = aqi.to_aqi([(aqi.POLLUTANT_so2_1h, str(SO2i))]) #ppb
#pm1aqi = aqi.to_aqi([(aqi.POLLUTANT_PM1, str(pm1))])
#pm2aqi = aqi.to_aqi([(aqi.POLLUTANT_PM25, str(pm2))]) #ug/m^3
pm10aqii = aqi.to_aqi([(aqi.POLLUTANT_PM10, str(PMi))]) #ug/m^3
##PM2i = alphasense.read_histogram()['PM2.5']
...
##    GPM2.append(PM2i)
    ...
    GO3.append(o3aqii)
    GSO2.append(so2aqii)
##td = open('Feb4begin.csv', 'w')
##header = ['Time', 'Temp', 'Humidity', 'CO', 'O3', 'SO2', 'NO2']
...
##        PM2 = alphasense.read_histogram()['PM2.5']
        ...
        #pm1aqi = aqi.to_aqi([(aqi.POLLUTANT_PM1, str(pm1))])
        #pm2aqi = aqi.to_aqi([(aqi.POLLUTANT_PM25, str(pm2))]) #ug/m^3
        pm10aqi = aqi.to_aqi([(aqi.POLLUTANT_PM10, str(PM))]) #ug/m^3
...
##        GPM2.pop(0)
        ...
        plotNow()
        plt.pause(.1)
#        writetd.writerow({'Time': Time, 'CO': CO, 'O3': O3, 'SO2': SO2, 'NO2': NO2, 'Temp': temp, 'Humidity': Humidity})
