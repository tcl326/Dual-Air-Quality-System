...
def plotNow():
    plt.clf()
    #ylim(20,25)
    plt.ax = plt.subplot(311)
    plt.ax2 = plt.subplot(312, sharex = ax)
    plt.ax3 = plt.subplot(313, sharex = ax)
...
##    plt.ax3.plot(GNO2, 'bx-', label='NO2 (AQI)')
##    plt.ax3.plot(GCO, 'gx-', label='CO (AQI)')
##    plt.ax3.plot(GO3, 'mx-', label='O3 (AQI)')
##    plt.ax3.plot(GSO2, 'kx-', label='SO2 (AQI)')
